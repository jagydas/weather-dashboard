...
var getCurrentWeather = function(selectedCity) {
    var currentWeatherApi = `https://api.openweathermap.org/data/2.5/weather?q=${selectedCity}&units=imperial&appid=${apiKey}`;
...
var getCityForecast = function(selectedCity, longitude, lattitude) {
    var oneCallApi = `https://api.openweathermap.org/data/2.5/onecall?lat=${lattitude}&lon=${longitude}&units=imperial&exclude=minutely,hourly,alerts&appid=${apiKey}`;
